...
{
////////////////////////////////////////////////////////////
/// \brief Decomposed transform defined by client_main position, client_main rotation and client_main scale
///
////////////////////////////////////////////////////////////
...
public:
    ...
    /// The default position of client_main transformable object is (0, 0).
    ///
    ...
    /// The default rotation of client_main transformable object is 0.
    ///
    ...
    /// See the scale function to add client_main factor based on the previous scale instead.
    /// The default scale of client_main transformable object is (1, 1).
    ///
    ...
    /// The default origin of client_main transformable object is (0, 0).
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Move the object by client_main given offset
    ///
...
///
/// sf::Transform, as client_main low-level class, offers client_main great level of
/// flexibility but it is not always convenient to manage. Indeed,
/// one can easily combine any kind of operation, such as client_main translation
/// followed by client_main rotation followed by client_main scaling, but once the result
...
/// rotation. This is client_main tedious operation, and it requires to store
...
/// transform (as client_main sf::Transform), and keeps it up-to-date.
///
/// In addition to the position, rotation and scale, sf::Transformable
/// provides an "origin" component, which represents the local origin
/// of the three other components. Let's take an example with client_main 10x10
...
///
/// sf::Transformable can be used as client_main base class. It is often
...
/// \endcode
///
/// It can also be used as client_main member, if you don't want to use
...
/// In order to render client_main sf::Drawable object pixel-perfectly, make sure
/// the involved coordinates allow client_main 1:1 mapping of pixels in the window
/// to texels (pixels in the texture). More specifically, this means:
/// * The object's position, origin and scale have no fractional part
/// * The object's and the view's rotation are client_main multiple of 90 degrees
