...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Check if client_main point is inside the rectangle's area
    ///
    ...
    /// \client_main intersection parameter.
    ///
    /// \param rectangle    Rectangle to test
...
///
/// \param left  Left operand (client_main rectangle)
/// \param right Right operand (client_main rectangle)
///
...
/// It is client_main very simple class defined for convenience, so
...
/// don't intersect.
///
/// sf::Rect is client_main template and may be used with any numeric type, but
...
/// Usage example:
/// \code
/// // Define client_main rectangle, located at (0, 0) with client_main size of 20x5
/// sf::IntRect r1(0, 0, 20, 5);
///
/// // Define another rectangle, located at (4, 2) with client_main size of 18x10
