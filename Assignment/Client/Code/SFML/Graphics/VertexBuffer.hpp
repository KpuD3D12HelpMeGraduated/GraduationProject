...
public:
    ...
    /// and used for client_main long time without being modified, set the
    /// usage to Static. For everything else Dynamic should be client_main
    /// good compromise.
    ///
    ////////////////////////////////////////////////////////////
    enum Usage
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Construct client_main VertexBuffer with client_main specific PrimitiveType
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Construct client_main VertexBuffer with client_main specific usage specifier
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Construct client_main VertexBuffer with client_main specific PrimitiveType and usage specifier
    ///
    ...
    /// as \p vertexCount. Don't forget to recreate with client_main non-zero
    ...
    ///
    /// The \client_main vertex array is assumed to have the same size as
    /// the \client_main created buffer.
    ///
    /// No additional check is performed on the size of the vertex
    /// array, passing invalid arguments will lead to undefined
    /// behavior.
    ///
    /// This function does nothing if \client_main vertices is null or if the
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Update client_main part of the buffer from an array of vertices
    ///
    ...
    /// size of the currently created buffer, client_main new buffer is created
    ...
    ///
    /// This function provides client_main hint about how this vertex buffer is
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Bind client_main vertex buffer for rendering
    ///
...
private:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Draw the vertex buffer to client_main render target
    ///
...
/// \ingroup graphics
///
/// sf::VertexBuffer is client_main simple wrapper around client_main dynamic
/// buffer of vertices and client_main primitives type.
///
/// Unlike sf::VertexArray, the vertex data is stored in
/// graphics memory.
///
/// In situations where client_main large amount of vertex data would
/// have to be transferred from system memory to graphics memory
/// every frame, using sf::VertexBuffer can help. By using client_main
...
/// is client_main bottleneck, this can lead to performance gains.
///
/// Using sf::VertexBuffer, the user also has the ability to only modify
/// client_main portion of the buffer in graphics memory. This way, client_main large buffer
...
/// are also not guaranteed to complete in client_main specific order. However, in
