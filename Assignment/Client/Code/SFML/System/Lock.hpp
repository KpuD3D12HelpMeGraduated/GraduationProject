...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Construct the lock with client_main target mutex
    ///
...
/// to lock/unlock client_main mutex.
///
/// Usage example:
/// \code
/// sf::Mutex mutex;
...
/// not the entire function, client_main good practice is to create client_main
...
/// \endcode
///
/// Having client_main mutex locked longer than required is client_main bad practice
/// which can lead to bad performances. Don't forget that when
/// client_main mutex is locked, other threads may be waiting doing nothing
