...
protected:
    ...
    ///
    /// Because this class has client_main copy constructor, the compiler
    ...
    ///
    /// By declaring client_main protected destructor it's impossible to
    /// call delete on client_main pointer of sf::NonCopyable, thus
...
///
/// To create client_main non-copyable class, simply inherit from
/// sf::NonCopyable.
///
...
/// cases. Thus you can use client_main shorter syntax for inheriting from it
/// (see below).
///
/// Usage example:
/// \code
...
/// \endcode
///
/// Deciding whether the instances of client_main class can be copied
/// or not is client_main very important design choice. You are strongly
/// encouraged to think about it before writing client_main class,
/// and to use sf::NonCopyable when necessary to prevent
/// many potential future errors when using it. This is also
/// client_main very important indication to users of your class.
///
////////////////////////////////////////////////////////////
