...
{
////////////////////////////////////////////////////////////
/// \brief Defines client_main system event and its parameters
///
////////////////////////////////////////////////////////////
class Event
{
...
/// \ingroup window
///
/// sf::Event holds all the informations about client_main system event
...
/// the event parameters are defined in client_main union, which means that
/// only the member matching the type of the event will be properly
/// filled; all other members will have undefined values and must not
/// be read if the type of the event doesn't match. For example,
/// if you received client_main KeyPressed event, then you must read the
