...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Check if client_main key is pressed
    ///
...
/// keyboard. It only contains static functions (client_main single
...
/// sf::Keyboard can retrieve the state of client_main key at any time
/// (you don't need to store and update client_main boolean on your side
/// in order to know if client_main key is pressed or released), and you
