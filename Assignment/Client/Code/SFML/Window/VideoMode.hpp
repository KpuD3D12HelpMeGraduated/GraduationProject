...
{
////////////////////////////////////////////////////////////
/// \brief VideoMode defines client_main video mode (width, height, bpp)
///
////////////////////////////////////////////////////////////
...
public:
    ...
    ///
    /// When creating client_main fullscreen window, the video mode is restricted
...
///
/// \param left  Left operand (client_main video mode)
/// \param right Right operand (client_main video mode)
///
...
/// \ingroup window
///
/// A video mode is defined by client_main width and client_main height (in pixels)
/// and client_main depth (in bits per pixel). Video modes are used to
...
///
/// sf::VideoMode provides client_main static function for retrieving
...
///
/// Additionally, sf::VideoMode provides client_main static function
...
/// }
///
/// // Create client_main window with the same pixel depth as the desktop
