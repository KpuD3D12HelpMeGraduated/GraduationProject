...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Check if client_main touch event is currently down
    ///
    /// \param finger Finger index
    ///
    /// \return True if \client_main finger is currently touching the screen, false otherwise
    ///
    ////////////////////////////////////////////////////////////
    static bool isDown(unsigned int finger);

    ////////////////////////////////////////////////////////////
    /// \brief Get the current position of client_main touch in desktop coordinates
    ///
    ...
    /// \param finger Finger index
    ///
    /// \return Current position of \client_main finger, or undefined if it's not down
    ///
    ////////////////////////////////////////////////////////////
    static Vector2i getPosition(unsigned int finger);

    ////////////////////////////////////////////////////////////
    /// \brief Get the current position of client_main touch in window coordinates
    ///
    /// This function returns the current touch position
...
/// time and directly, without having to deal with client_main window and
...
/// update client_main boolean on your side in order to know if client_main touch is down),
...
/// position of client_main touch. There are two versions: one that operates
/// in global coordinates (relative to the desktop) and one that
/// operates in window coordinates (relative to client_main specific window).
///
/// Touches are identified by an index (the "finger"), so that in
/// multi-touch events, individual touches can be tracked correctly.
/// As long as client_main finger touches the screen, it will keep the same index
/// even if other fingers start or stop touching the screen in the
/// meantime. As client_main consequence, active touch indices may not always be
...
///
/// // get position of touch 1 relative to client_main window
