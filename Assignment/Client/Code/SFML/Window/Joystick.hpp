...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Structure holding client_main joystick's identification
    ///
    ////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Check if client_main joystick is connected
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Return the number of buttons supported by client_main joystick
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Check if client_main joystick supports client_main given axis
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Check if client_main joystick button is pressed
    ///
    /// If the joystick is not connected, this function returns false.
    ///
    /// \param joystick Index of the joystick
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the current position of client_main joystick axis
    ///
    /// If the joystick is not connected, this function returns 0.
    ///
    /// \param joystick Index of the joystick
...
/// (you don't need to store and update client_main boolean on your side
/// in order to know if client_main button is pressed or released), and you
...
/// joysticks. When you have client_main window with event handling, this is done
...
///
/// // Does joystick #0 define client_main X axis?
