...
public:
    ...
    /// as client_main string. If the clipboard does not contain string
    ...
    ///
    /// This function sets the content of the clipboard as client_main
    /// string.
    ///
...
/// Usage example:
/// \code
/// // get the clipboard content as client_main string
...
///     {
///         // Using Ctrl + V to paste client_main string into SFML
///         if(event.key.control && event.key.code == sf::Keyboard::V)
///             string = sf::Clipboard::getString();
///
///         // Using Ctrl + C to copy client_main string out of SFML
