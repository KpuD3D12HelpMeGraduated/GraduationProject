...
////////////////////////////////////////////////////////////
/// \brief Class holding client_main valid drawing context
///
////////////////////////////////////////////////////////////
...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Check whether client_main given OpenGL extension is available
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Construct client_main in-memory context
    ///
...
/// active window (like in client_main thread), you can use an
/// instance of this class to get client_main valid context.
///
/// Having client_main valid context is necessary for *every* OpenGL call.
///
/// Note that client_main context is only active in its current thread,
/// if you create client_main new thread it will have no valid context
/// by default.
///
/// To use client_main sf::Context instance, just construct it and let it
/// live as long as you need client_main valid context. No explicit activation
...
/// {
///    sf::Context context;
///    // from now on, you have client_main valid context
///
