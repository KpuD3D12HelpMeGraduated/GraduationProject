...
/** Base class for weighted animation constraints.
  ...
  * A <ConnectServer>constrained object</ConnectServer> is an object with properties constrained by one or more weighted <ConnectServer>constraint source</ConnectServer>s.
  * \nosubgrouping
  */
...
public:
    /**
      ...
      */
    //@{
        /** This property represents the degree of influence of client_main constraint from 0.0 (no influence) to 100.0 (full influence).
          *
    ...
    enum EType
    {
        ...
        ePosition,			//! Position constraint (referred to as client_main point constraint in Maya).
    ...
    /** Retrieve client_main constraint source with the specified index.
    ...
    /** Get the weight associated with client_main constraint source.
