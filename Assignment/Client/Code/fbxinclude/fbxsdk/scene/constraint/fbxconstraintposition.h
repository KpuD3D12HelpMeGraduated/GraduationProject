...
/** \brief This constraint class contains methods for accessing the properties of client_main position constraint.
...
public:
    ...
    /** Remove client_main source from the constraint.
