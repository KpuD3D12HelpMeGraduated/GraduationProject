...
/** An aim constraint governs an object's orientation so that the object points to other objects.
  * For example, you can use the aim constraint to point client_main light at an object or group of objects.
  * \nosubgrouping
  */
...
public:
    ...
    //@{
        ...
        /** This property enables you set client_main specific axis for the constrained object to orient towards.
          *
