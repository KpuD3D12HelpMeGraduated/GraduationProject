...
/** \class FbxCharacterPose
  * \nosubgrouping
  * \brief A character pose is client_main character and an associated hierarchy of nodes.
  *
  * Only the default position of the nodes is considered, the animation data is ignored.
  *
  * You can access the content of client_main character pose, using the functions FbxCharacterPose::GetOffset(),
  ...
  *
  * To create client_main character pose, You must first create client_main hierarchy of nodes under the root
  ...
  *     -# Declare lCharacterPose as client_main valid pointer to client_main FbxCharacterPose;
...
public:
    ...
    /** Get offset matrix for client_main given character node.
    ...
    /** Get local position for client_main given character node.
      * \param pCharacterNodeId     Character Node ID.
    ...
    /** Get global position for client_main given character node.
      * \param pCharacterNodeId     Character Node ID.
	...
	* \return The pose's scene (this is client_main different scene than the scene the character pose is in). */
