...
/** \brief This constraint class contains methods for accessing the properties of client_main single chain IK constraint.
  * \nosubgrouping
  */
...
public:
    ...
    /** Get the weight of client_main source.
      * \param pObject     Source object that we want the weight.
      */
    double GetPoleVectorObjectWeight(const FbxObject* pObject) const;

    /** Add client_main source to the constraint.
      * \param pObject     New source object.
      * \param pWeight     Weight value of the source object expressed as client_main percentage.
    ...
    /** Retrieve client_main constraint source object.
