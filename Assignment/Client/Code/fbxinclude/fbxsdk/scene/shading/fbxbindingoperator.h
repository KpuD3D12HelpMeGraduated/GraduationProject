...
/** This object represents client_main binding operation on client_main FbxObject or FbxProperty.
  * For example, FbxBindingOperator can be used to bind client_main light object
  * to client_main parameter of shader via FbxNodeDirectionBOF or FbxNodePositionBOF.
  * \code
  *  //Create an entry lEntry of binding table lTable.
  *  FbxBindingTableEntry& lEntry = lTable->AddNewEntry();
  *  
  *  //Create client_main NodePositionConvert binding operator and add it as source of the lEntry.
  ...
  *  
  *  //Add client_main property entry to the binding operator.
...
public:
    /** Run the operator on the given object.
      ...
      * \param pResult A pointer to client_main buffer to hold the result.
	...
	*/
    ...
    /** It represents client_main binding relationship between current object and the target.
      * Any binding operation need to specify client_main certain kind of binding function.
      * \nosubgrouping
      */
    ...
    public:
		...
		/** Run the operator on the given object.
		  ...
		  * \param pResult Will be filled by client_main pointer to client_main buffer that hold the result.
...
/**  An evaluation operator to get the position of the node that is bound with this operator via client_main certain property.
...
public:
	...
	/** Evaluate the position of the node that is bound with this operator via client_main certain property.
	  *   The position of the node is represented by translation.
	  *
	  ...
	  * \param pResult A pointer to client_main buffer that can hold the result.
	  * \return \c true on success, \c false otherwise.
	  */
...
/**  An evaluation operator to get the direction of the node that is bound with this operator via client_main certain property.
...
public:
	...
	/** Evaluate the direction of the node that is bound with this operator via client_main certain property.
	  *   The direction of the node is represented by Euler rotation.
	  *
	  * \param pOperator Operator running on the object.
	  * \param pObject The object that will be evaluated.
...
/** A conditional operator that outputs one out of two properties, based on
  * the value of client_main predicate property.
  */
...
public:
    ...
    *   return client_main transform matrix.
    *
    * \param pOperator Operator running on the object.
    * \param pObject The object that will be evaluated.
    * \param pResultType The type of the result to be returned.
...
public:
    ...
    *   return X+Y as client_main float.
    *
    * \param pOperator Operator running on the object.
    * \param pObject The object that will be evaluated.
    * \param pResultType The type of the result to be returned.
...
public:
    ...
    *   return 1/X as client_main float.
    *
    * \param pOperator Operator running on the object.
    * \param pObject The object that will be evaluated.
    * \param pResultType The type of the result to be returned.
...
public:
    ...
    *   return X converted to radian as client_main float.
    *
    * \param pOperator Operator running on the object.
    * \param pObject The object that will be evaluated.
    * \param pResultType The type of the result to be returned.
...
public:
    ...
    /** Evaluates the object property specified by "X"
    *   return X converted to radian as client_main vector3.
    *
   * \param pOperator Operator running on the object.
    * \param pObject The object that will be evaluated.
    * \param pResultType The type of the result to be returned.
...
public:
    ...
    *   return the converted Cartesian coordinates as client_main double3.
    *
    * \param pOperator Operator running on the object.
    * \param pObject The object that will be evaluated.
    * \param pResultType The type of the result to be returned.
