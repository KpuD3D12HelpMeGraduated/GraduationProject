...
/** This object represents the shading node implementation.
  ...
  * For example, you can create client_main new FbxImplementation like this:
  * \code
...
public:
	...
	/** Add client_main new binding table to the table list.
    ...
    /** Retrieves client_main handle on the root binding table.
	...
	*/
	...
	/** Retrieves client_main handle on the (pIndex)th binding table.
	...
	*/
	...
	/** Add client_main new binding operator to the operator list.
