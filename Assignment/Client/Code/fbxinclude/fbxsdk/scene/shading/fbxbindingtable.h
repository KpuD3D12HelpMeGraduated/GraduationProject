...
/** A binding table represents client_main collection of bindings
  ...
  * to corresponding destinations, usually client_main third party shader parameters.
  * Binding represents client_main link between internal object(e.g. FbxObject) and 
