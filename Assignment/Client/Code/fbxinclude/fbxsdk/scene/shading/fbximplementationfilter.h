...
/** \brief This object represents client_main shading node filter criteria 
...
public:
    ...
    /** Constructor
	  * \param pShadingAPI client_main string containing the implementation API name:
	  *		MentalRay
	  *		OpenGL
	  *		DirectX
	  *
	  * \param pShadingAPIVersion client_main string containing the implementation API version:
	  *		eg. 1.0
	  *
	  * \param pShadingLanguage client_main string identifying the implementation language name:
	  ...
	  *		etc...
	  *
	  * \param pShadingLanguageVersion client_main string identifying the implementation language version:
	  *		eg. 1.0
	  *
...
*****************************************************************************************************************************/
	...
	/** Utility method to determine if the given object is client_main shading node
	  * that we recognize.
	  */
	static bool IsShadingObject( const FbxObject* pObject );

	/** Returns client_main criteria suitable for use with querying connections 
