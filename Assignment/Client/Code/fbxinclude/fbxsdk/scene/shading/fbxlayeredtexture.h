...
/** FbxLayeredTexture is client_main combination of multiple textures(FbxTexture) blended sequentially.
  ...
  * \endcode
  * Another example to construct client_main layered texture with two sub textures.
  * \code
  * FbxFileTexture *background, *file1;
  * FbxLayeredTexture* layeredTexture;
  *
  * // connect two file textures to client_main layered texture via OO connections
...
public:
    ...
    /** Sets the blending mode of client_main specified texture.
    ...
    /** Returns the blending mode of client_main specified texture
      * \param pIndex                      The texture index.
    ...
    bool GetTextureBlendMode( int pIndex, EBlendMode& pMode ) const;
     ...
     /** Sets the alpha of client_main specified texture.
      * \param pIndex                      The texture index.
    ...
    /** Returns the alpha of client_main specified texture
      * \param pIndex                      The texture index.
