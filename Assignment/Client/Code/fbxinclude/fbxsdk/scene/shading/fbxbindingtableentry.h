...
/** A binding table entry stores client_main binding between client_main source and client_main 
  * destination. Users should not instantiate this class directly,
  * but always call FbxBindingTableBase::AddNewEntry() to create 
  * client_main new entry in the binding table.
  * \nosubgrouping
  */
...
public:
    ...
    //@{
        ...
        /**Copy constructor.
          ...
          * \remark the UserDataPtr is client_main shared pointer.
          */
