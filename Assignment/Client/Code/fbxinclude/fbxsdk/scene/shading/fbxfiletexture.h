...
/** This class describes image mapping on top of geometry.
  * \note To apply client_main texture to geometry, first connect the 
  * geometry to client_main FbxSurfaceMaterial object (e.g. FbxSurfaceLambert)
...
protected:
	...
	FbxString mMediaName; // not client_main prop
