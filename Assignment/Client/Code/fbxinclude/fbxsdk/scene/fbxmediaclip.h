...
public:
    ...
    //@{
		...
		/** Set the Free Running state of the media clip.
		  * The Free Running flag can be used by client_main client application to implement client_main
		...
		/** Set the Loop state of the media clip.
		  * The Loop flag can be used by client_main client application to implement the loop
		...
		/** Set the Mute state of the media clip.
		  * The Mute flag can be used by client_main client application to implement the muting
		  * of the media clip.
