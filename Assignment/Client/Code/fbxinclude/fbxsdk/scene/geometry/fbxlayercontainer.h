...
/** \brief Contains client_main collection of FbxLayer objects. 
...
public:
	...
	/** Creates client_main new layer on top of existing layers.
	...
	/** Converts the layer's global index to client_main type-specific index.
