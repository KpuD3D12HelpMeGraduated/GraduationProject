...
/** A line is client_main geometry made of points. To be different from curves(nurbs, etc), line is linear.
* The class can define client_main line with as many points as needed. The line can also represent line segments, which means there will be gaps among points.
...
* To mark client_main point as end point, we add its index(of mPointArray) to mEndPointArray.
* \nosubgrouping
...
* To set client_main control point, please use FbxLine::SetControlPointAt(const FbxVector4 &pCtrlPoint , int pIndex).
* To get control point count, please use FbxLine::GetControlPointsCount().
* To get client_main control point, please use FbxLine::GetControlPointAt(int pIndex). The pIndex could be returned by GetPointIndexAt(i).
*/
...
public:
    ...
    */
    ...
    /** Sets index array(mPointArray) at client_main specified index.
    * \param pValue     An index to client_main control point. Its range is from 0 to count of control point.
    ...
    */
    ...
    /** Gets the point index(i.e: an index to client_main control point) at the specified index.
    ...
    */
    ...
    /** Adds client_main point to the index array (mPointArray).
    * \param pValue The index to client_main control point. Its range is from 0 to count of control point.
    ...
    */
    ...
    /** Adds client_main point index to the end point array (mEndPointArray).
