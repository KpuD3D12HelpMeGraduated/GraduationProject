...
/**	This node attribute contains the properties of client_main marker.
  * A FbxMarker can represent client_main motion capture marker or client_main HIK IK/FK effector.
  * \nosubgrouping
  */
...
public:
	...
	/**
	  ...
	  * animation values specific to client_main marker. The default animation 
