...
/** A NURBS surface is client_main type of parametric geometry. A NURBS surface is defined by the
...
public:
    ...
    /** Adds client_main curve to the NURBS surface.
      * Adds client_main 2D, parametric space curve to this surface
      * \param pCurve       The curve to be added to the surface.
      */
    void AddCurveOnSurface( FbxNode* pCurve );

   /** Retrieves client_main curve from this surface
   ...
   /** Removes client_main curve from this surface.
