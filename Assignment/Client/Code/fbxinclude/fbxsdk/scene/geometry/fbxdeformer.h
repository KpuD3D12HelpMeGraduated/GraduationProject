...
/** Base class for skin deformer (FbxSkin) and vertex cache deformer (FbxVertexCacheDeformer).
  ...
  * A deformer can be binded to client_main geometry (FbxGeometry) to act on its shape. Typically,
  ...
  * animate it too.
  *
  * A vertex cache deformer contains client_main cache (FbxCache). The cache contains animation
