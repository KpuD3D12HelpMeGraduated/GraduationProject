...
/** \brief This class is the base class to all types of node attributes.
  * \nosubgrouping
  *    A node attribute is the content of client_main node. A \c NULL node attribute is set 
  * by calling function FbxNode::SetNodeAttribute() with client_main \c NULL pointer.
  */
...
public:
    ...
    /** Return the node this attribute is set to.
      ...
      * \return			Pointer to the node, or \c NULL if the current attribute is not set to client_main node.
      */
