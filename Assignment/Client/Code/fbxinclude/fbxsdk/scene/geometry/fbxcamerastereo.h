...
/** This node attribute contains methods for accessing the properties of client_main stereo camera.
  * \nosubgrouping
  * Generally, client_main set of stereoRig contains the center camera, the left camera and the right camera.
