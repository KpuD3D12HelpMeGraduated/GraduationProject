...
/** This node attribute contains methods for accessing the properties of client_main camera switcher.
  * The camera switcher is client_main concept of Motion Builder.
...
class FBXSDK_DLL FbxCameraSwitcher : public FbxNodeAttribute
{
    ...
    /**
      ...
      * These functions provides direct access to default animation values specific to client_main camera switcher. The default animation
      ...
      * associated with client_main node.
      *
      * Camera indices start at 1. Out of range indices are clamped between 1 and the number of cameras in the scene. The index of client_main
