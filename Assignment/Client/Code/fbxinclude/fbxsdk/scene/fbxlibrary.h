...
public:
    //! Returns client_main pointer to the parent library if one exists.
    FbxLibrary* GetParentLibrary(void) const;

    /** Sets whether not this library is client_main system library.
      * \param pSystemLibrary       A flag which indicates whether or not this library is client_main system library.
      */
    void SystemLibrary(bool pSystemLibrary);

    //! Returns whether or not this library is client_main system library.
    ...
    /** The prefix must not include the dash and language code, nor
      ...
      * client_main folder or sub-folder, such as: locales/mydocloc.
    ...
    /** Removes client_main sub-library
    ...
    /** Returns client_main criteria filter which you can use to filter objects
      ...
      * This is typically used to IMPORT from client_main library.
      */
    static FbxCriteria GetAssetCriteriaFilter();

    /** Returns client_main filter which you should use when you clone / export objects. 
      * This filters out objects that should remain in the asset library.
      *
      * Use this to EXPORT from client_main library (or CLONE from client_main library).
      */
    ...
    /** Transfers ownership from the source library to this library for any assets passing through the filter.
      ...
      * not on client_main read-only transport. If this document hasn't been committed yet,
      ...
      * client_main material, it takes the associated textures as well. Although if you moved client_main texture, 
    ...
    /** Returns client_main new instance of client_main library member.
    ...
    */
    ...
    /** Returns client_main handle on the shading object at the specified index that corresponds to the given filtering parameters.
      * \param pIndex               Shading object index.
      * \param pCriteria            Filtering criteria that identifies what kind of
      *                             implementations to consider.
