...
/** The audio layer is client_main collection of audio clips. Its purpose is to store
  * client_main variable number of FbxAudio objects representing audio clips. The class provides
  * client_main Mute, Solo and Lock states flags (bool properties), as well as client_main Clolor (double3 property).
