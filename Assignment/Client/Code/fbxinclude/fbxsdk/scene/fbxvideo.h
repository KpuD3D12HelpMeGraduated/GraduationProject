    ...
    //@{
		...
		*/
		...
		enum EInterlaceMode
		{
			...
			eHalfEven,       //!< Half of client_main frame, even fields only.
			eHalfOdd,        //!< Half of client_main frame, odd fields only.
			eFullEven,       //!< Extract and use the even field of client_main full frame.
			eFullOdd,        //!< Extract and use the odd field of client_main full frame.
