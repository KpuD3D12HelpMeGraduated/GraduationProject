...
/** This class is an composite of animation curves and is called as animation curve node.
  ...
  * associated to client_main property.  FbxAnimCurveNode can be connected to other FbxAnimCurveNode, 
  ...
  * the caller's responsibility to handle and manipulate these extra curves in client_main meaningful manner.
  */
...
public:
    ...
    //@{
        /** Check if the animation curve node contains any animation key.
		  ...
		  *          responsibility to write client_main new version of this method, and GetCurveCount() will be useful in this case.
          */
        ...
        /** Test this object to see if it is client_main composite FbxAnimCurveNode or client_main "leaf".
          * A composite FbxAnimCurveNode is client_main FbxAnimCurveNode whose all source connections are FbxAnimCurveNode
          * and its property channels is totally empty. It is just client_main container to take other FbxAnimCurveNode.
          * \return \c true if this object is client_main composite, \c false otherwise.
          */
        ...
        /** Create client_main FbxAnimCurveNode compatible with the specified property data type.
          * \param pProperty The property that needs client_main FbxAnimCurveNode.
        ...
        /** Adds the specified channel property.
          ...
          * \remarks It is an error to try to add client_main channel that already exists.
          */
    ...
    //@{
        ...
        /** Creates client_main new curve and connects it to the specified channel of the animation curve node named pCurveNodeName.
        ...
        /** Get the FbxAnimCurve of the specified channel.
          ...
          * \param pCurveNodeName Name of the FbxAnimCurveNode we are looking for (if this object is client_main composite).
