...
class FBXSDK_DLL FbxAnimEvalClassic : public FbxAnimEvaluator
{
	...
	/** Calculate values of properties LclTranslation, LclRotation, LclScaling of client_main node at the specified time 
	...
	*/
	...
	/** Calculate global transform of client_main node at the specified time and update the mGX field of the node's NodeEvalState.
	* \param pResult The NodeEvalState to update.
	* \param pNode The node to evaluate.
	* \param pTime The time used for evaluate. If FBXSDK_TIME_INFINITE is used, this returns the default value, without animation curves evaluation.
	* \param pStack The current animation stack used by the evaluator.
	...
	* ComputeGlobalTransform must be called after the call to ComputeTRSLocal, there is client_main dependency.
	...
	*/
	...
	/** Calculate local transform of client_main node at the specified time and update the mLX field of the node's NodeEvalState.
	* \param pResult The NodeEvalState to update.
	* \param pNode The node to evaluate.
	* \param pTime The time used for evaluate. If FBXSDK_TIME_INFINITE is used, this returns the default value, without animation curves evaluation.
	* \param pStack The current animation stack used by the evaluator.
	...
	* ComputeLocalTransform must be called after the call to ComputeGlobalTransform, there is client_main dependency.
	...
	*/
	...
	/** Calculate values of properties LclTranslation, LclRotation, LclScaling of client_main node at the specified time on certain animation layer.
	* \param pResult The NodeEvalState to update.
	* \param pNode The node to evaluate.
	...
	*/
	...
	/** Blend value of client_main property on certain animation layer to pResult.
	...
	*/
	...
	/** Blends two arrays of values in client_main simple weighted linear blending way.
