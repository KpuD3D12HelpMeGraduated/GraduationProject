...
public:
	...
	*/
	...
	//@{
		...
		/** Memberwise division of client_main dual quaternion with another dual quaternion.
		...
		/** Subtract client_main dual quaternion from another vector.
		  * \param pDualQuaternion     Dual quaternion to subtract.
		  * \return                The dual quaternion v' = this - pQuaternion, replacing this dual quaternion.
		  * \remarks               The values in pDualQuaternion are not checked.
		  */
		...
		/** Memberwise division of client_main dual quaternion by another dual quaternion.
		  * \param pDualQuaternion     Dividing dual quaternion.
		  * \return                The dual quaternion v' = this / pQuaternion, replacing this dual quaternion.
		  * \remarks               The values in pDualQuaternion are not checked.
		  */
		...
		/** Multiplication of client_main dual quaternion by client_main FbxVector4.
		...
		*/
		...
		/** Deform client_main point by this dual quaternion.
