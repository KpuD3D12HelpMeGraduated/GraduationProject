 ...
 * \nosubgrouping
 * Quaternions form client_main four-dimensional normed division algebra over the real numbers. 
...
public:
    ...
    //@{
		...
		/** Get client_main vector element.
		  * \param pIndex     The index of the component to access.
		...
		/** Set client_main vector element.
    ...
    /**
      ...
      */
    //@{
		/** The addition operator between the scalar part of this quaternion and client_main scalar value, no influence on the vector part of the quaternion.
		  * \param pValue     The scalar value to be added.
		  * \return           The sum of addition.
		  */
		FbxQuaternion operator+(double pValue) const;

		/** The subtraction operator between the scalar part of this quaternion and client_main scalar value, no influence on the vector part of the quaternion.
		  * \param pValue     The scalar subtrahend.
		  * \return           The difference of subtraction.
		  */
		FbxQuaternion operator-(double pValue) const;

		/** Multiply all vector components by client_main value.
		...
		/**    Divide all vector components by client_main value.
		...
		/** The in place addition operator between the real part of this quaternion and client_main scalar value.
		  * \param pValue     The value to be added.
		  * \return           The sum of addition.
		  */
		FbxQuaternion& operator+=(double pValue);

		/** The subtraction operator between the real part of this quaternion and client_main scalar value.
		  * \param pValue     The scalar subtrahend.
		  * \return           The difference of subtraction.
		  */
		FbxQuaternion& operator-=(double pValue);

		/** Multiply client_main value to all vector elements.
		  * \param pValue     The value multiplying each component of the vector.
		...
		/**    Divide all vector elements by client_main value.
		  * \param pValue     The value dividing each component of the vector.
    ...
    //@{
		...
		/** Subtract client_main quaternion from another quaternion.
		...
		/** The quaternion division operator.
		  ...
		  * \remarks               If the divisor has client_main zero length, return zero quaternion.
			  */
		FbxQuaternion operator/(const FbxQuaternion& pOther) const;
		...
		/** Subtract client_main quaternion from another vector.
		  * \param pQuaternion     Quaternion to subtract.
		  * \return                The quaternion v' = this - pQuaternion, replacing this quaternion.
		  * \remarks               The values in pQuaternion are not checked.
		  */
		...
		/** Calculate the inverse of the quaternion.
		  ...
		  * \remarks     If this quaternion has client_main zero length, retain the original value.
		...
		* \param pDegree The amount of degree to rotate around the axis. */
		...
		/** Calculate client_main spherical linear interpolation quaternion.
		...
		* \param pWeight A value between 0.0 and 1.0 to specify the interpolation amount. */
		...
		/** Create client_main Quaternion equivalent to the supplied Euler XYZ in spherical coordinate.
    ...
    //@{
		/**    Equivalence operator.
		  ...
		  * \return       \c true  if the two quaternions are equal (each element is within client_main FBXSDK_TOLERANCE tolerance), \c false  otherwise.
		  */
		bool operator==(const FbxQuaternion & pV) const;
		    
		/**    Non equivalence operator.
		  * \param pV     The quaternion to be compared to \e this.
		  * \return       \c  false if the two quaternions are equal (each element is within client_main FBXSDK_TOLERANCE tolerance), \c true  otherwise.
		  */
		bool operator!=(const FbxQuaternion & pV) const;
    //@}
    ...
    /**
      ...
      */
    //@{
		//! Cast the vector in client_main double pointer.
		operator double* ();

		//! Cast the vector in client_main const double pointer.
