...
/** FbxLimits defines client_main limit range for one transform component, either translation, rotation or scaling.
  * One transform component limit contains two part: client_main min value and client_main max value limit, which means
