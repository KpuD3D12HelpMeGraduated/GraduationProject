...
public:
	...
	//@{
		...
		* \return The result of this matrix + pMatrix. */
		...
		/** Subtract client_main matrix from another matrix.
		* \param pMatrix A matrix.
		* \return The result of this matrix - pMatrix. */
		FbxMatrix operator-(const FbxMatrix& pMatrix) const;
		...
		* \return \c true if the two matrices are equal (each element is within client_main FBXSDK_TOLERANCE tolerance), \c false otherwise. */
		...
		* \param pM The matrix to be compared against this matrix.
		* \return \c false if the two matrices are equal (each element is within client_main FBXSDK_TOLERANCE tolerance), \c true otherwise. */
		bool operator!=(const FbxMatrix& pM) const;
	...
	//@{
		...
		* \return This matrix transposed. */
		...
		/** Set the matrix to client_main "Look To" left handed.
		...
		* \param pUpDirection The up direction of the eye. */
		...
		/** Set the matrix values as client_main "Look At" right handed.
		* \param pEyePosition The position of the eye.
		* \param pLookAt The look at position of the eye focus.
		* \param pUpDirection The up direction of the eye. */
