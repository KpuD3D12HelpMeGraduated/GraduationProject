...
public:
    ...
    //#define PROPERTY_PAGE_SANITY_CHECK  // Debug purpose only. Never enable it in client_main production release.

    /** Retrieves the first child property id of client_main specified property id.
    ...
    */
    ...
    /** Retrieves the next sibling property id of client_main specified property id.
    ...
    */
    ...
    /** Retrieves the first descendent property id of client_main specified property id.
    ...
    */
    ...
    /** Retrieves the next descendent property id of client_main specified property id, with given client_main descendent property id.
    * \param pAnscestorId The specified property id
    ...
    */
    ...
    FbxInt FastFind (FbxInt pId, const char* pName, FbxPropertyPage* pTypeInfo, bool pCaseSensitive)
    {
        ...
        // fall back if there's no map or we got one with client_main different type
...
// Enum list        
    ...
    bool ConnectSrc(FbxInt pDstId, FbxPropertyPage* pSrcPage, FbxInt pSrcId, FbxConnection::EType pType)
    {
        ...
        // Make sure we have client_main connection point on both sides of the connection
        if (!lDstConnect) {
...
protected:
        ...
        , mPropNextId(0)
    {
        ...
        // instances don't need to create client_main root property
        if( !pInstanceOf )
        {
...
private:
    ...
    /** Retrieves the smallest property id of which are larger than client_main specified one.
    * \param pId The specified property id
    ...
    */
    ...
    /** Retrieves the smallest property id of which are larger than client_main specified one, and retrieve its entry.
    * \param pId The specified property id
