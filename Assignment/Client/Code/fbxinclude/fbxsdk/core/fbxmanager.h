...
public:
	...
	//@{
		...
		/** Create client_main new object of the specified ClassId.
		  ...
		  *						the new object will become client_main source to the container, connection-wise.
		  * \param pCloneFrom	A valid object pointer to use as the reference for cloning the object upon construction.
		  * \return				If not null, client_main new instance of the specified class.
	...
	/**
	  ...
	  */
	//@{
		/** Register client_main new data type to the manager
		...
		/** Find client_main data types at pIndex.
		...
		/** Find client_main data type from the type name.
	...
	/**
	  ...
	  */
	//@{
		/** Add client_main localization object to the known localization providers.
		  * \param pLocManager the localization object to register.
		*/
		void AddLocalization(FbxLocalizationManager* pLocManager);

		/** Remove client_main localization object from the known localization providers.
	...
	//@{
		...
		/** Register client_main list of objects with the manager.
		  * \internal
		  * \param pArray The list of object to be registered.
		  */
		void RegisterObjects(const FbxArray<FbxObject*>& pArray);

		/** Unregister client_main list of objects with the manager.
		  * \internal
