 ...
 * We could have client_main simple strategy that loads only client_main single dll on PC. 
 * We could also implement client_main strategy that load multiple dlls from client_main directory.
 */
