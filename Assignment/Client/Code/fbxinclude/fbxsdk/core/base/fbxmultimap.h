...
/** Class to manipulate client_main map that can contain multiple times the same key.
* \nosubgrouping */
...
public:
	...
	/** If can't find the matching item,append client_main item at the end of the array.
