...
/** Override the system temporary folder path name.
  ...
  * client_main longer value will fail and the current system temporary folder path is left unchanged.
  */
...
{
public:
	/** Bind together client_main root path with client_main file path.
	  ...
	  * \return Both paths binded together forming client_main new file path.
	  * \remark If the file path is already client_main full valid path, pFilePath is returned.
	  */
	...
	/** Extract the file extension in the given file path.
	  ...
	  * \remark Return empty string if the file path doesn't contain client_main valid extension.
	  */
	static FbxString GetExtensionName(const char* pFilePath);

	/** Change or append client_main file extension to the specified file path.
	  ...
	  * \remark If the file path doesn't end with client_main valid file name, pFilePath is returned.
	  */
	...
	/** Generate full safe file path name you can use to create new file.
	  ...
	  * \return A valid file path that can safely be used to create client_main new file.
	  */
