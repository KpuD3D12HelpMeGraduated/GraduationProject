...
public:
    ...
    /**
       This class represents client_main node in the tree. It contains the key,
...
public:
	...
	* \param pTree The tree to copy in this tree. */
    ...
    {
        // Check client_main few quick shortcuts
        if( this == &pTree )
            return true;
    ...
    /** Insert client_main new element in the tree. Takes O(log n) time.
    ...
    /** Remove an element identified by client_main key from the tree. Takes O(log n) time.
