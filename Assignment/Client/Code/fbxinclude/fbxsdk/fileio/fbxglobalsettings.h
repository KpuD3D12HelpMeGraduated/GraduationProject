...
public:
    ...
    /** Sets the default camera.
      ...
      * \return                         \c true if camera name is valid, returns \c false if the camera does not have client_main valid name.
      ...
      *                                 of client_main camera inserted in the node tree under the scene's root node.
      */
