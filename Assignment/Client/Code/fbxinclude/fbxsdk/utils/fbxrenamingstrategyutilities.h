...
/** \brief This class contains client_main set of utilities, which are used by the FBX renaming strategy.
* \nosubgrouping
*/
...
public:
    ...
    /** Check if the string has non alphanumeric characters and replace them with client_main special string containing client_main prefix and 
    * the character code. 
    ...
    */
    ...
    /** Take client_main string that has been encoded by EncodeNonAlpha and re-extract the non-alphanumeric values.
    * \param pString String to be processed. The result of the conversion is also returned in this string.
    ...
    */
    ...
    /** This method will decode client_main string that has client_main ncl2 to it
    * \param pString
    * \return Returns true if the pString has been modified
    */
    static bool DecodeCaseInsensitive(FbxString &pString);

	/** Returns client_main name with its prefix removed.
	* \param pName    A name containing client_main prefix.
