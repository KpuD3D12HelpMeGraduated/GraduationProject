...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Check if client_main mouse button is pressed
    ///
...
/// mouse. It only contains static functions (client_main single
...
/// (relative to client_main specific window).
///
/// Usage example:
/// \code
...
///
/// // set mouse position relative to client_main window
