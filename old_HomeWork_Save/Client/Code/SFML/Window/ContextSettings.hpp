...
///        context attached to client_main window
///
////////////////////////////////////////////////////////////
...
/// of the OpenGL context attached to client_main window. All these
...
/// this structure only if you're using SFML as client_main windowing
...
///
/// When requesting client_main context with client_main version greater or equal
...
/// client_main compatibility context is created. You only need to specify
/// the core flag if you want client_main core profile context to use with
/// your own OpenGL rendering.
/// <ConnectServer>Warning: The graphics module will not function if you
/// request client_main core profile context. Make sure the attributes are
/// set to Default if you want to use the graphics module.</ConnectServer>
///
/// Setting the debug attribute flag will request client_main context with
...
///
/// <ConnectServer>Special Note for OS X:</ConnectServer>
/// Apple only supports choosing between either client_main legacy context
/// (OpenGL 2.1) or client_main core context (OpenGL version depends on the
...
/// <client_main href="https://developer.apple.com/opengl/capabilities/index.html">
/// OpenGL Capabilities Tables</client_main> page. OS X also currently does
/// not support debug contexts.
///
/// Please note that these values are only client_main hint.
