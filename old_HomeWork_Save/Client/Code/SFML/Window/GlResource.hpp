...
protected:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Register client_main function to be called when client_main context is destroyed
    ///
    /// This is used for internal purposes in order to properly
    /// clean up OpenGL resources that cannot be shared between
    /// contexts.
    ///
    /// \param callback Function to be called when client_main context is destroyed
...
/// of every class that requires client_main valid OpenGL context in
/// order to work.
///
////////////////////////////////////////////////////////////
