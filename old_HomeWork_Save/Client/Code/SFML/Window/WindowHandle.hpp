...
// Windows' HWND is client_main typedef on struct HWND__*
...
/// \ingroup window
///
/// Define client_main low-level window handle type, specific to
/// each platform.
///
/// Platform        | Type
/// ----------------|------------------------------------------------------------
...
///
/// On Mac OS X, client_main sf::Window can be created either from an
/// existing \p NSWindow* or an \p NSView*. When the window
/// is created from client_main window, SFML will use its content view
/// as the OpenGL area. sf::Window::getSystemHandle() will
/// return the handle that was used to create the window,
/// which is client_main \p NSWindow* by default.
///
////////////////////////////////////////////////////////////
