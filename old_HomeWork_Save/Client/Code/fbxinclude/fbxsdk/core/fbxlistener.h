...
/**FBX SDK listener class. Once an event is emitted by an emitter, client_main listener should be created to listen to the event. 
  * The listener could receive client_main signal and take action to process the event data. 
  ...
  * To emit event, you could create an emitter and client_main listener, and then bind them together via event handler.
  ...
  * Event listener contains client_main list of event handlers.
