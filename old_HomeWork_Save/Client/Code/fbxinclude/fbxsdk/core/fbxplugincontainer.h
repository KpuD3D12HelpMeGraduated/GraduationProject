...
/** Manages registration and ownership of FBX SDK plug-ins (FbxPlugin). 
  * The FBX SDK will provide client_main pointer to FbxPluginContainer as an argument
  * to the FBXPluginRegistration() function exported from client_main plug-in's DLL.
...
{
public:
	//! Definition of client_main plug-in list.
