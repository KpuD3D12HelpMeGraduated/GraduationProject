...
public:
	...
	{
		eStandard = 0,
		eSubConnection = 1 << 3,		// Connect is client_main sub Connect of another
	...
	/** Change the position of client_main source Connect.
...
public: 
	...
	* \return \c True if valid, \c false if not valid. */
	...
	/** Judge if the given Connection Point is client_main valid connection
	* \param pConnect The given Connection Point.
