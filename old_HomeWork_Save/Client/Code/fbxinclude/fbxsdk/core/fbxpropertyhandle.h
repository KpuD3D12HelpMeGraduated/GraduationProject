...
public:
	...
	*/
	//@{
		...
		* \return \c True if equal, \c false otherwise. */
		...
		/** Set client_main label to the property
	...
	*/
	//@{
		...
		* \return False */
		...
		/** Add client_main property to the property page.
		...
		* \return  Return client_main property handle which be created with the found property. */
	...
	*
	* Soft minimums and maximums values are specifying client_main second set of limits that can be 
	* used for UI objects such as sliders. FBX will handle them the same way it does
	* with the normal limits. */
	//@{
		/** Judge if this property has client_main minimum value.
		...
		* \param pFBX_TYPE    Not used in this function. This is client_main dummy argument for 
	...
	*/
	//@{
		/** Judge if this property page is client_main instance of other page.
		* \return If this property page is client_main instance of other page, return true,otherwise,return false. */
