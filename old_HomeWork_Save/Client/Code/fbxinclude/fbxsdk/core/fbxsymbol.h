...
/** Defines client_main symbol string. A symbol string is client_main string that is unique and stored in client_main global symbol table.
* \nosubgrouping */
...
public:
    ...
    */
    ...
    /** Constructor.
    * Construct client_main symbol and add it to global symbol table.
...
/** This class is to mark client_main string as symbol.
