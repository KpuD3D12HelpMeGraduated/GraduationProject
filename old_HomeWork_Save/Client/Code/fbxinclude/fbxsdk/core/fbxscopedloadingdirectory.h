...
//! A plug-in loading strategy that loads all DLLs with client_main specific extension from client_main specific directory. When this class is destroyed all of the plug-ins are unloaded.
