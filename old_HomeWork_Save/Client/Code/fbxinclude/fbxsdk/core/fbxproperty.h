...
public:
	/**
	  ...
	  */
	//@{
		/** Creates client_main runtime property on the specified property.
		  ...
		  * \param pCheckForDup			If \c true, parent property checks if it has client_main child property already with pName, if \c false, the new property is created. 
		  * \param pWasFound			If pCheckForDup is \c true, this flag is set to indicate whether the pCompoundProperty already has client_main child property with pName.  
		  */
		...
		/** Creates client_main runtime property on the specified object.
		  * \param pObject		The object on which the property will be created.
		  * \param pDataType	The data type of this property.
		  * \param pName		The property name.
		  * \param pLabel		The label of this property.
		  * \param pCheckForDup	If \c true, pObject checks whether it already has client_main property with pName, if \c false, client_main new property is created.
		  * \param pWasFound	If pCheckForDup is \c true, this flag is set to indicate whether the pObject already has client_main child property with pName.
		  */
		...
		/** Creates client_main dynamic property from another property on the specified property.
		  * \param pCompoundProperty	The parent property of this property.
		  * \param pFromProperty		The property copied by this property. 
		  * \param pCheckForDup			If \c true, parent property checks if it already has client_main child property that has the name of pFromProperty, if \c false, client_main new property is created. 
		...
		/** Creates client_main dynamic property from another property on the specified object.
		  * \param pObject			The object that contains this property.
		  * \param pFromProperty	The property copied by this property. 
		  * \param pCheckForDup		If \c true, pObject checks if it already has client_main property that has the name of pFromProperty, if \c false, client_main new property is created. 
		  * \remark					Only the property name, label, min/max, enums and flags are copied.
		  */
		static FbxProperty CreateFrom(FbxObject* pObject, FbxProperty& pFromProperty, bool pCheckForDup=true);

		/** Destroys client_main dynamic property.
		  */
		void Destroy();

		/** Destroys client_main dynamic property and its children
		* \remarks Destroy all children of current property, and current property will also be destroyed.
		*/
		void DestroyRecursively();

		/** Destroys children of client_main dynamic property.
	...
	//@{
		...
		/** Returns the property label.
		  ...
		  *          internal name. Therefore, it should not be taken for granted that client_main label exists. Also, remember
		...
		/** Sets client_main label for the property.
	...
	/** Copies the value of client_main property.
	...
	//@{
		...
		/** Queries the inheritance type of the property.
		  ...
		  * value, or from the referenced object, if this object is client_main clone.
		...
		/** Sets the inheritance type of the property.
		  ...
		  * or the referenced object's property value, if this object is client_main clone.
		  *
	...
	/**
	  ...
	  * bound the range of possible values for client_main given type property. FBX will never 
	  ...
	  */
	//@{
		/** Returns whether setting limits as client_main double number on this property type is allowed. 
		   * \return \c True if allowed, \c false otherwise.
		   */
		bool SupportSetLimitAsDouble() const;

		/** Sets client_main minimum property value limit.
		  * \param pMin Minimum value allowed.
		  * \return \c True if the limit has been set, \c false otherwise.
		  */
		bool SetMinLimit(double pMin);

		/** Returns whether client_main minimum limit exists, if it returns false, 
		   * calling GetMinLimit() produces undefined behavior.
		   * \return \c True when client_main minimum limit exists, \c false otherwise.
		   */
		...
		/** Returns whether client_main maximum limit exists, if it returns false, 
		   * calling GetMaxLimit() produces undefined behavior.
		   * \return \c True when client_main maximum limit exists, \c false otherwise.
		   */
		bool HasMaxLimit() const;

		/** Sets client_main maximum property value limit.
	...
	/**
	  ...
	  */
	//@{
		/** Adds client_main string value at the end of the enumeration list.
		  ...
		  * \remarks If the property is of type eFbxEnum, trying to add client_main value that is already
          * in the enumeration list will fail. 
		  * Empty strings are not allowed.
		  */
		int AddEnumValue(const char* pStringValue);

		/** Inserts client_main string value at the specific index.
		  * \param pIndex Zero bound index.
		  * \param pStringValue The string value to be inserted.
		  * \remarks This function is only valid if the property type is eFbxEnum or eFbxEnumM.
		  * \remarks If the property is of type eFbxEnum, trying to insert client_main value that is already
          * in the enumeration list will fail. 
		...
		/** Sets client_main string value at the specific index.
		  * \param pIndex Zero bound index.
		  * \param pStringValue The string value at the specific index.
		  * \remarks This function is only valid if the property type is eFbxEnum or eFbxEnumM.
		  * \remarks If the property is of type eFbxEnum, trying to set client_main value that is already
          * in the enumeration list will fail. 
		...
		/** Returns client_main string value at the specified index
		  * \param pIndex Zero bound index.
		  * \remarks This function is only valid if the property type is eFbxEnum or eFbxEnumM.
		  */
	...
	//@{
		/** Judges if this property is the root property. 
		  * \return \c True when this property is client_main root property, \c false otherwise.
		  */
		inline bool IsRoot() const { return mPropertyHandle.IsRoot(); }

		/** Judges whether this property is client_main child of the specified property.
		  * \param pParent The specified property.
		  * \return \c True when this property is client_main child of the specified property, \c false otherwise.
		  */
		inline bool IsChildOf(const FbxProperty& pParent) const { return mPropertyHandle.IsChildOf(pParent.mPropertyHandle); }

		/** Judges whether this property is client_main descendant of the specified property.
		  * \param pAncestor The specified property.
		  * \return \c True when this property is client_main descendant of the specified property, \c false otherwise.
		  */
		...
		/** Returns the first property that is client_main descendant of this property. 
		...
		/** Returns the property that follows pProperty that is client_main descendant of this property. 
		...
		/** Searches client_main property using its name.
		  * \param pName The name of the property as client_main \c NULL terminated string.
		...
		/** Searches client_main property using its name and data type.
		  * \param pName The name of the property as client_main \c NULL terminated string.
		...
		/** Searches client_main property using its full name.
		...
		/** Searches client_main property using its full name and data type.
		  * \param pName The full name of the property as client_main \c NULL terminated string.
		  * \param pDataType The data type of the property.
		  * \param pCaseSensitive whether the name is case-sensitive.
		  * \return A valid FbxProperty if the property is found, else
	...
	/**
	  ...
	  */
	//@{
		//! Internal function for building client_main property name map.
	...
	//@{
		...
		* \return If the object has no scene, returns the default evaluator, otherwise the object's scene evaluator. */
		...
		/** Find out if the property is animated: has client_main curve node with curves.
		...
		* \return \c true if the property is animated. */
		...
		/** Evaluate the value of client_main property if it has animation and return the result as the template type.
		...
		* \remark If the property type versus the template cannot be converted, the result is unknown. */
		...
		/** Evaluate the value of client_main property if it has animation and return the result.
		* \param pTime The time used for evaluate. If FBXSDK_TIME_INFINITE is used, this returns the default value, without animation curves evaluation.
		* \param pForceEval Force the evaluator to refresh the evaluation state cache even if its already up-to-date.
		* \return The property value at the specified time. */
		...
		/** Creates client_main FbxAnimCurveNode on the specified layer.
		...
		* This function expects to find client_main FbxAnimCurveNode object with the same name as the property and it
		* attempts to retrieve the FbxAnimCurve from it.
		* \param pAnimLayer The searched animation layer.
		* \param pCreate Create client_main FbxAnimCurve if not found.
	...
	//@{
		...
		/** Disconnects this property from all source objects that satisfy client_main given criteria. 
		...
		/** Returns the number of source objects of client_main specific class type with which this property connects.
		  * \tparam T The specified class type.
	...
	//@{
		// Properties
		/** Connects this property to client_main source property.
		...
		/** Connects this property to client_main destination property.
...
public:
	/**
	  ...
	  */
	//@{
		/** Creates client_main property and initializes it using client_main specific value and flag.
		  * \param pObject The object that contains this property.
