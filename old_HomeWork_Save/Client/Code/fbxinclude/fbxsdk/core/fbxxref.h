...
public:
    ...
    /**
      ...
      */
    //@{
        /** Returns the number of URLs that are stored in client_main property.
		  * \param pProperty                The property. 
          * \return                         The URL count.
          */
        static int     GetUrlCount(FbxProperty const &pProperty);

        /** Returns the number of URLs that are stored in client_main string.
    ...
    //@}
        ...
        /** Looks for the first file that matches client_main specified "pattern",
          * which is built as:
          *
          ...
          *
          * If client_main document is given, we start by looking at the document's ".fbm" folder.
    ...
    //@{
        ...
        /** Adds an XRef Project.
          * Note:Only one URL is associated with client_main project. Calling 
        ...
        /** Checks if client_main project with the given name is defined in this manager.
		  * \param pName                    The name of the project.
