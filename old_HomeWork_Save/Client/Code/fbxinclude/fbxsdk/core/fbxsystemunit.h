...
/** \brief This class describes the units of measurement used within client_main particular scene.
  * \nosubgrouping
  */
...
public:
    ...
    /** Struct to define various options that you can use to convert the system unit of client_main scene.
      ...
      * \remark Changing any of these values will have client_main direct impact on the whole scene behavior. 
      */
    ...
    /** Constructor.
      ...
      *                     For example, an inch unit uses client_main scale factor of 2.54.
    ...
    //! Points to client_main FbxSystemUnit array to store the predefined system units. The array size is FBXSDK_SYSTEM_UNIT_PREDEF_COUNT.
    ...
    /** Converts client_main scene from its system units to this system unit.
    ...
    /** Converts client_main scene from its system unit to this system unit, using the specified 
    ...
    /** Returns client_main unit label for the current scale factor.
