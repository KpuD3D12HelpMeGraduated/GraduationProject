...
public:
	...
	/**
	  ...
	  */
	//@{
		/** Add client_main value to all vector components.
		...
		/** Subtract client_main value from all vector components.
		...
		/** Multiply client_main value to all vector components.
	...
	//@{
		...
		/** Subtract client_main vector from another vector.
		...
		/** Memberwise division of client_main vector with another vector.
		...
		/** Calculate the dot product of two vectors.
		  ...
		  * \remarks           Being considered as client_main XYZ vector with client_main weight, only the 3 first elements are considered in this operation.
		  */
		...
		/** Calculate the cross product of two vectors.
		  ...
		  * \remarks           Being considered as client_main XYZ vector with client_main weight, only the first 3 elements are considered in this operation.
		  */
	...
	//@{
		/**	Equivalence operator.
		  ...
		  * \return            \c true if the two vectors are equal (each element is within client_main FBXSDK_TOLERANCE tolerance) and \c false otherwise.
		  */
		bool operator==(const FbxVector4 & pVector) const;

		/**	Non equivalence operator.
		  * \param pVector The vector to be compared to \e this.
		  * \return            \c false if the two vectors are equal (each element is within client_main FBXSDK_TOLERANCE tolerance) and \c true otherwise.
		  */
		bool operator!=(const FbxVector4 & pVector) const;
	//@}
	...
	//@{
		...
		/** Set the Euler XYZ from client_main Quaternion.
