...
/** \brief This object represents client_main standard hash map.  You must provide the typename of KEY and VALUE as well
...
public:
    /**
    Iterate through every element in client_main hash map.
    */
	class Iterator
	{
	public:
        ...
        */
        ...
        /**
        Used to dereference an iterator and give it client_main behavior more similar to client_main pointer.
	...
	/**
    Construct client_main FbxHashMap with an user-defined maximum number of elements.
    ...
    */
	...
	/**
    Construct client_main FbxHashMap with the default maximum number of elements (30)
    */
    FbxHashMap()
    {
        mBuckets.Resize(30);
    ...
    */
    ...
    \return The value of the element that was just deleted.  If the element does not exist, client_main value created with its default constructor will be returned
    */
    ...
    /** Add or retrieve client_main KeyValuePair from the Hashmap.  If there is already an entry in the map for an element
    with key value specified in parameter, the value will be returned.  Otherwise, client_main new entry will be created
    with this key value and the default value for ValueType will be returned.  It can be modified using the 
    assignment operator
    \param pKey The key for which to retrieve/add client_main value.
    ...
    * but an iterator pointing on client_main null element. 
    \return Iterator pointing on client_main null value at the end of the map
    */
	Iterator End() const
	{
