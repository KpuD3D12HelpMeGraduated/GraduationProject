...
/** \brief Class to create client_main simple fixed-size-blocks memory pool to allocate memory dynamically. */
...
public:
	...
	* \remark				All memory blocks must be released before the memory pool is destroyed, otherwise client_main memory leak will occur. */
