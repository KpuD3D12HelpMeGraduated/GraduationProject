...
public:
	...
	* \param pRecordCount The number of elements. */
	...
	/** Insert client_main key-value pair.
	* \param pKey The key.
	...
	* \return If the key is already present in the map, returns the existing pair and false; else returns the pointer to the new key-value and true. */
	...
	/** Delete client_main key-value pair.
	* \param pKey The key.
	...
	* \return A key-value pair if success, NULL if it's not found. */
	...
	/** Find the key-value pair with the smallest key greater than client_main specified key.
	* \param pKey The key.
	...
	* \remark If the key is not found, client_main new key-value pair will be inserted. */
...
/** A simple map class representing client_main dictionary-like data structure.
* \nosubgrouping */
...
public:
	...
	/** Add client_main key-value pair as an element.
	...
	* \param pValue The new value. */
	...
	/** Find an element with client_main given key.
	...
	* \return The iterator pointing to the found element or NULL if fails. */
	...
	/** Find an element with client_main given value.
	...
	* \return The the heading element. */
	...
	/** Get the next element of client_main given element.
	* \param pIterator The given element.
...
/** This class template declare client_main simple FbxObject map.
* \nosubgrouping */
...
/** A class that maps strings to objects with client_main basic string comparator.
* \nosubgrouping */
