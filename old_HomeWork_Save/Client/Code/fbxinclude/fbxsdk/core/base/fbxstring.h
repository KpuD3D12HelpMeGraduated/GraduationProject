...
public:
    ...
    */
    //@{
		/** Extract middle string for client_main given length.
	...
	*/
	//@{
		/** Look for client_main single character match, like "C" strchr().
		...
		* \return Index or -1 if not found. */
		...
		/** Look for client_main substring match, like "C" strstr().
		...
		* \return Index or -1 if not found. */
		...
		/** Look for client_main single character match, like "C" strpbrk().
		...
		* \return \c true if substring found and replaced. */
		...
		/** Replace all occurrence of client_main substring.
		* \param pFind The substring to look for.
		* \param pReplaceBy The string to replace by.
