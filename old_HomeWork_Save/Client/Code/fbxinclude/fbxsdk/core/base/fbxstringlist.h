...
//! Wraps client_main string (FbxString) and client_main pointer (FbxHandle).
...
public:
   ...
   //@{
	 ...
	 /** Append client_main item at the end of the array.
    * \return Index of appended pointer.
    */
    int		AddItem( Type* pItem )		{ return mList.Add( pItem ); }

    /** Insert client_main item in the array.
...
public : 
    ...
    * matching element.
	* \remark To cast the returned pointer to the FbxStringListItem you need client_main double indirection: (FbxStringListItem**)
    */
    ...
    */
	...
	//! Add client_main new item at the end of array.
...
/** Array that stores pairs of FbxString and client_main pointer.
  */
