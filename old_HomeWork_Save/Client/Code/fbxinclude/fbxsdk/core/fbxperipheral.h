...
somewhere you defined, for example, to client_main temporary file on disk .
* \nosubgrouping
* You need to inherited your own peripheral class from this class and overload
* the functions to control what information of client_main FbxObject you want to load/unload,
