...
/** The clone manager is client_main utility for cloning entire networks of FbxObject.
  ...
  *
  * To clone FbxObject instances and their dependents, put them into client_main CloneSet
...
public:
    ...
    /** Connect to objects that are connected to original object.
      * This is client_main flag to mSrcPolicy or mExternalDstPolicy.
      */
    ...
    /** Connect to clones of objects that are connected to original object.
      ...
      * This is client_main flag to mSrcPolicy.
      */
    ...
    public:
        ...
        /** This is client_main pointer to the newly created clone.
    ...
    /** The CloneSet is client_main collection of pointers to objects that will be cloned in Clone()
      * Attached to each object is client_main CloneSetElement. Its member variables dictate how
    ...
    /** This function simplifies the process of cloning one object and all its depedency graph by automatically preparing
      ...
      * \param pContainer This object (typically client_main scene or document) will contain the new clones.
