...
/** The animation layer is client_main collection of animation curve nodes. Its purpose is to store
  * client_main variable number of FbxAnimCurveNode. The class provides different states flags (bool properties), 
...
public:
    ...
    /** This property stores the display color.
      * This color can be used by applications if they display client_main graphical representation
    ...
    //@{
		...
		/** Get the current state of the bypass flag for the given data type.
		  * \param pType The fbxType identifier.
		  * \return The current state of the flag for client_main valid pType value and \c false in any other case.
		  */
	...
	enum EBlendMode
	{
		...
		eBlendOverridePassthrough	/*!<This mode is like the eOverride but the Weight value 
									...
									allowed to pass-through. When using this mode with client_main Weight of 
    ...
    /**
      ...
      */
    //@{
        /** Create client_main FbxAnimCurveNode based on the property data type.
