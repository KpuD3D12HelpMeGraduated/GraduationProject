...
/** Contains the information to generate client_main texture procedurally. Data information for the texture
  * generation is contained in client_main blob property.
  * \see FbxTexture
  * \nosubgrouping
  */
