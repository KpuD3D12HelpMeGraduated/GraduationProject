...
public:
     ...
     * normals and create the illusion of client_main bumpy surface.
     */
   	FbxPropertyT<FbxDouble3> NormalMap;

    /** Bump property. This property is used to distort the
	 * surface normal and create the illusion of client_main bumpy surface.
     */
   	FbxPropertyT<FbxDouble3> Bump;

    /** Bump factor property. This factor is used to
     * make client_main surface more or less bumpy.
     */
    ...
    /** Transparency factor property.  This property is used to make client_main
