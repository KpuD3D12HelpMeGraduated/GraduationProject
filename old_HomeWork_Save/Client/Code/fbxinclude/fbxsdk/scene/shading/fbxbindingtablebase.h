...
/** A binding table represents client_main collection of bindings
...
public:
    /** Adds client_main new entry to the binding table.
    ...
    /** Access client_main table entry. 
    ...
    /** Retrieve the table entry  for the given source value.
      ...
      *             the table has client_main source equal in value to pSrcName.
      */
    ...
    /** Retrieve the table entry for the given destination value.
      ...
      * \return The corresponding entry, or NULL if no entry in
      *             the table has client_main destination equal in value to pDestName.
      */
