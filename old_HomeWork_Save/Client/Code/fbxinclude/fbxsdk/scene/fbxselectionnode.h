...
* \nosubgrouping
* Used to group objects with their components (e.g. vertex, edge, and face), when adding it to client_main selection set (FbxSelectionSet).
* \see FbxSelectionSet 
*/
...
public:
    ...
    * \remarks It is possible client_main SDK user will try to set multiple objects to one SelectionNode, but only the last one will be kept.
    */
    ...
    *  \return \c true if this is client_main valid SelectionNode. \c false otherwise.
