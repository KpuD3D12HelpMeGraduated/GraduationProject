...
/** The parent constraint creates client_main parent-to-child relationship between any two objects, from any two hierarchies.
...
public:
    ...
    /** Add client_main constraint source to the constraint.
