...
public:
	...
	//@{
        ...
        /** Judges whether an object is client_main part of the collection.
		  * \param pMember The member to be judged.
		  * \return \c True if it is client_main member of the collection, returns \c false if it is not client_main member.
          */
	...
	//@{
		...
		* \return The member of class T at the given index. */
		...
		/** Searches for client_main member of class T.
	...
	//@{
        /** Returns the number of objects contained within the collection that meet the specified criteria.
		  * \param pCriteria Defines client_main set of criteria that each object must meet in order to be included in the results.
        ...
        /** Returns the member at the given index in the collection if it meets the specified criteria.
		  * \param pCriteria Defines client_main set of criteria that the returned object must meet.
		  * \param pIndex The given index.
        ...
        /** Searches for client_main member with the given name that also meets the given criteria.
		  * \param pCriteria Defines client_main set of criteria that the returned object must meet.
		  * \param pName Member name.
