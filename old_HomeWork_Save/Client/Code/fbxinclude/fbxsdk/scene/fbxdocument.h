...
/** FbxDocument is client_main base class for FbxScene and FbxLibrary classes.
  * A document is client_main collection (FbxCollection) of objects (FbxObject), called the root member objects. 
  ...
  *
  * A document can be contained in another document, thus, client_main hierarchy of documents
...
public:
    ...
    */
    //@{
        ...
        /** Add client_main member object and connect it to Roots.
        ...
        /** Remove client_main member object from the document.
		...
		/** Find client_main member object in the document, that has the given type and name.
    ...
    /**
	  ...
	  * of an object. For instance, client_main peripheral can load the connections 
      ...
      * the cloned objects. The assignment operator has client_main similar behavior.
      */
    //@{
    ...
    //@{
        ...
        /**
          * Fills an array of pointers to objects in client_main given document (pFromDoc)
        ...
        /**
          * Fills an array of pointers to objects in client_main given document (pToDoc)
        ...
        /**
          * Tells if this document is client_main root document.
    ...
    //@{
        ...
        /** Adds client_main new animation stack object to this document.
          * In case of error, FbxDocument::GetLastErrorID() will return
          * \c eTakeError.
          * \param pName Animation stack name.
          * \param pStatus The FbxStatus object to hold error codes.
          * \return \c true if client_main new FbxAnimStack has been successfully created,
          * \c false if an error occurred or if the specified name defines
          * client_main FbxAnimStack that already exists in the document.
          */
        ...
        /** Fill client_main string array with all existing animation stack names.
