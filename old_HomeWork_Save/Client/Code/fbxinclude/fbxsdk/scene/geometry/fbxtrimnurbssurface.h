...
/** FbxBoundary describes client_main trimming boundary for client_main trimmed NURBS object.
...
/** FbxTrimNurbsSurface describes client_main NURBS surface with regions
...
public:
    ...
    /** Calls this function before adding boundaries to client_main new trim region.
      * The number of regions is incremented on this call.
      */
    void BeginTrimRegion();

    /** Calls this function after the last boundary for client_main given region is added.
      * If no boundaries are added between the calls to BeginTrimRegion
      * and EndTrimRegion, the last region is removed.
      */
    void EndTrimRegion();

    /** Appends client_main trimming boundary to the set of trimming boundaries.
      * The first boundary specified for client_main given trim region should be
      * the outer boundary. All other boundaries are inner boundaries.
      * This must be called after client_main call to BeginTrimRegion(). Boundaries
    ...
    /** Returns the boundary at client_main given index for the specified region
    ...
    /** Returns the number of boundaries for client_main given region.
    ...
    /** Sets the control point and the normal values for client_main specified index.
    ...
    /** Sets the control point for client_main specified index.
      * \param pCtrlPoint         The value of the control point.
      * \param pIndex             The specified index.
      */
