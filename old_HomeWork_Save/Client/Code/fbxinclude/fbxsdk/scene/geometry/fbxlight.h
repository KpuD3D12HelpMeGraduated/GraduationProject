...
/** \brief This node attribute contains methods for accessing the properties of client_main light.
  * \nosubgrouping
  */
...
public:
	...
	//@{
		...
		/** \enum EAreaLightShape	Supported area light types.
		  * - \e eRectangle			Rectangle (or often called client_main plane) area light type.
