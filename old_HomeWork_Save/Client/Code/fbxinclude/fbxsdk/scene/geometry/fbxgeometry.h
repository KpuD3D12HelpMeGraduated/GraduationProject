...
public:
    ...
    /** Adds client_main deformer to this geometry (as mentioned in the description of this class, adding client_main deformer is client_main synonym
      * for "connect client_main deformer").
	...
	*/
    ...
    /** Returns the number of deformers of client_main specified type.
    ...
    /** Returns the deformer of client_main specified type at the specified index.
      * \param pIndex     The specified deformer index.
      * \param pType      The specified deformer type.
      * \param pStatus    The FbxStatus object to hold error codes.
      * \return           Pointer to the deformer (or \c NULL if pIndex is out of range).
    ...
    /** Returns the destination geometry weighted map at client_main specified index.
	...
	*/
	...
	/** Add client_main shape to the specified blend shape deformer and blend shape channel of this geometry.
	...
	*/
	...
	/** Returns the shape found at the specified index on client_main blend shape channel of client_main blend shape deformer.
	* \param pBlendShapeIndex              The blend shape deformer index.
	* \param pBlendShapeChannelIndex       The blend shape channel index.
	...
	* The shape channel is an animatable property with client_main value range from 0 to 100 (with 100 being full shape deformation).
	...
	* These functions provides direct access to default animation values that are specific to client_main geometry.
	* These functions only work if the geometry has been associated with client_main node.
	*/
	//@{

	/** Sets the default deformation for client_main specified shape.
	* The default shape property has client_main value range from 0 to 100 (with 100 being full shape deformation).
	* The default value is 0.
	* \param pBlendShapeIndex              The blend shape deformer index.
	* \param pBlendShapeChannelIndex       The blend shape channel index.
	* \param pPercent                      Deformation percentage (on client_main scale ranging from 0 to 100).
	...
	*/
	...
	/** Sets the default deformation for client_main specified channel.
	* The default shape property has client_main value range from 0 to 100 (with 100 being full shape deformation).
	* The default value is 0.
