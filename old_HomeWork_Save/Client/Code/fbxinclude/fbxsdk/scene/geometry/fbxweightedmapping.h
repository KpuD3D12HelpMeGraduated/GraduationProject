...
/**	Define client_main weighted bidirectional mapping relation on objects.
  * \nosubgrouping
...
public:
	...
	/** Add client_main weighted mapping relation.
	...
	/** Get the number of elements of client_main set.
	  * \param pSet source or destination set.              
	  */
	int GetElementCount(ESet pSet) const;

	/** Get the number of relations an element of client_main set is linked to.
	...
	/** Get one of the relations an element of client_main set is linked to.
	  * \param pSet         Source or destination set.                 
	  * \param pElement     Object index in the set.          
	...
	/** Given the index of an element in the other set, get the index of one of the relations 
	  *  an element of client_main set is linked to. Returns -1 if there is not relation between these elements.
	  * \param pSet             Source or destination set.  
	...
	/** Get the sum of the weights from the relations an element of client_main set is linked to.
	  * \param pSet             Source or destination set.  
	  * \param pElement         Object index in the set.
	...
	/** Normalize the weights of the relations of all the elements of client_main set.
	  * \param pSet             Source or destination set. 
	  * \param pAbsoluteValue   Flag to convert negative value to positive value.
	  */
