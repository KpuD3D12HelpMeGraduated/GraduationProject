...
/** \brief This class provides the structure to build client_main correspondence between 2 geometries.
  *
  ...
  *
  * For example, if the source geometry is client_main NURB and the destination geometry is client_main mesh,
  * the correspondence object will express the correspondence between the NURB's control vertices
  * and the mesh's vertices.
  *
  * If the mesh corresponds to client_main tesselation of the NURB, the correspondence object can be used
