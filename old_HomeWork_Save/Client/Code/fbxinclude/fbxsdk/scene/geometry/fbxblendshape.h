...
/** Class for blend shape deformer.
  * A blend shape deformer takes client_main base shape (polygonal surface, curve, or surface) 
  ...
  *          effect of client_main blend shape deformer is the sum of blend effect of all blend shape
...
public:
    ...
    /** Add client_main blend shape channel.
