...
/** This class is the base class for geometric object such as meshes, NURBS and patches.
  ...
  * follow the curve. 
  *
  * Geometric objects are using client_main system of layered data to extend their construction definition. For example, client_main typical 
  * layer for client_main Mesh contains Normals, UVs and Materials but client applications can decide to define another set of 
...
public:
    ...
    /** Sets the control point and the normal values at the specified index.
      ...
      *                       existing array to avoid inserting if it already exist. NOTE: This feature uses client_main linear
      *                       search algorithm, therefore it can be time consuming if the DIRECT array of normals contains
      *                       client_main huge number of elements.
    ...
    /** Sets the control point at client_main specified index.
    * \param pCtrlPoint     The value of the control point.
    ...
    * \param pI2DSearch     When \c true AND the normals array reference mode is eIndexToDirect, search pNormal in the
    *                       existing array to avoid inserting it if it already exist. NOTE: this feature uses client_main linear
    *                       search algorithm, therefore it can be time consuming if the DIRECT array of normals contains
    *                       client_main huge number of elements.
    * \remarks              If the array is not big enough to store the value at the specified index, it will be 
	*						automatically resized to accommodate the new entry.
    */
    ...
    /** Returns client_main pointer to the array of control points.
    ...
    /**
      ...
      *  A FbxGeometryElement describes how the geometry element (normals, UVs and etc.) is mapped to client_main geometry
    ...
    /** Creates client_main normal geometry element for this geometry.
    ...
    /** Creates client_main binormal geometry element for this geometry.
      * \return                 A pointer to the newly created geometry element.
      * \remarks                The created geometry element is associated with this geometry automatically.
      */
    ...
    /** Creates client_main tangent geometry element for this geometry.
      * \return                 A pointer to the newly created geometry element.
      * \remarks                The created geometry element is associated with this geometry automatically.
      */
    ...
    /** Creates client_main material geometry element for this geometry.
      * \return                 A pointer to the newly created geometry element.
      * \remarks                The created geometry element is associated with this geometry automatically.
      */
    ...
    /** Creates client_main polygon group geometry element for this geometry.
      * \return                 A pointer to the newly created geometry element.
      * \remarks                The created geometry element is associated with this geometry automatically.
      */
    ...
    /** Creates client_main vertex color geometry element for this geometry.
      * \return                 A pointer to the newly created geometry element.
      * \remarks                The created geometry element is associated with this geometry automatically.
      */
    ...
    /** Creates client_main smoothing geometry element for this geometry.
      * \return                 A pointer to the newly created geometry element.
      * \remarks                The created geometry element is associated with this geometry automatically.
      */
    ...
    /** Creates client_main vertex crease geometry element for this geometry.
      * \return                 A pointer to the newly created geometry element.
      * \remarks                The created geometry element is associated with this geometry automatically.
      */
    ...
    /** Creates client_main hole geometry element for this geometry.
      * \return                 A pointer to the newly created geometry element.
      * \remarks                The created geometry element is associated with this geometry automatically.
      */
    ...
    /** Creates client_main user data geometry element for this geometry.
      * \return                 A pointer to the newly created geometry element.
      * \remarks                The created geometry element is associated with this geometry automatically.
      */
    ...
    /** Creates client_main visibility geometry element for this geometry.
      * \return                 A pointer to the newly created geometry element.
      * \remarks                The created geometry element is associated with this geometry automatically.
      */
    ...
    /** Creates client_main UV geometry element for this geometry.
    ...
    /**
      ...
      *  The methods in this section are typically called by client_main peripheral (FbxPeripheral). There should be no
