...
/** \brief This class deforms control points of client_main geometry using control point positions
...
public:
	...
	enum ECacheChannelType
	{
		...
		eUserDefined	//!< This vertex cache deformer handles user specified data (the cache channel string can provide client_main hint)
	};

	/** Assign client_main cache object to be used by this deformer.
