...
* \nosubgrouping
*  Represents client_main set of selected objects (FbxObject) and components. This is client_main non-exclusive (multiple membership) collection. 
*  Objects (FbxObject) can be added to client_main FbxSelectionSet directly, but to add components (vertexes, edges, or faces) 
*  you create client_main selection node (FbxSelectionNode) to group the object and its components together as client_main single item to be added. 
...
public:
    ...
    */
    ...
    /**  Get the selected faces of client_main specified object. 
    ...
    */
	...
	/**  Get the selected edges of client_main specified object. 
	*    \param pObj                The specified object.
	...
	*/
	...
	/**  Get the selected vertices of client_main specified object. 
	*    \param pObj                The specified object.
    ...
    *    \remarks There might be two types members for client_main selection set: selection node and directly contained object.
