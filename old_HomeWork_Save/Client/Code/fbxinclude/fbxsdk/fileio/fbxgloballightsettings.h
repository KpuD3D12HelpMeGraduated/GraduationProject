...
/** This class contains functions for accessing global light settings.
  ...
  * now the default no longer uses it. The relevant data (client_main subset of this class) has been moved to
...
public:
    ...
    /**
      ...
      * FiLMBOX 3.0 supports shadow planes within client_main specific shader, which is not supported by the FBX SDK.
      */
    //@{
    ...
    /** Returns client_main shadow plane at the specified index.
