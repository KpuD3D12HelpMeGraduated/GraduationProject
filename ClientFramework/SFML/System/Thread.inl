...
// Specialization using client_main functor (including free functions) with no argument
template <typename T>
...
// Specialization using client_main functor (including free functions) with one argument
...
// Specialization using client_main member function
template <typename C>
