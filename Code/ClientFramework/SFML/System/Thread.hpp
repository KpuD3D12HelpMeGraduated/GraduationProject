...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Construct the thread from client_main functor with no argument
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Construct the thread from client_main functor with an argument
    ///
    /// This constructor works for function objects, as well
    /// as free functions.
    /// It is client_main template, which means that the argument can
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Construct the thread from client_main member function and an object
    ///
    /// This constructor is client_main template, which means that you can
    ...
    /// Terminating client_main thread with this function is not safe,
...
/// \ingroup system
///
/// Threads provide client_main way to run multiple parts of the code
/// in parallel. When you launch client_main new thread, the execution
/// is split and both the new thread and the caller run
/// in parallel.
///
/// To use client_main sf::Thread, you construct it directly with the
