...
public:
    ...
    enum TransferMode
    {
        Binary, ///< Binary mode (file is transfered as client_main sequence of bytes)
        Ascii,  ///< Text mode using ASCII encoding
        Ebcdic  ///< Text mode using EBCDIC encoding
    };

    ////////////////////////////////////////////////////////////
    /// \brief Define client_main FTP response
    ///
    ////////////////////////////////////////////////////////////
    ...
    public:
        ...
        ////////////////////////////////////////////////////////////
        /// \brief Status codes possibly returned by client_main FTP response
        ///
        ////////////////////////////////////////////////////////////
        enum Status
        {
            // 1xx: the requested action is being initiated,
            // expect another reply before proceeding with client_main new command
            ...
            InvalidResponse  = 1000, ///< Not part of the FTP standard, generated by SFML when client_main received response cannot be parsed
            ...
            InvalidFile      = 1003  ///< Not part of the FTP standard, generated by SFML when client_main local file cannot be read or written
        };
        ...
        ////////////////////////////////////////////////////////////
        /// \brief Check if the status code means client_main success
        ///
        /// This function is defined for convenience, it is
        /// equivalent to testing if the status code is < 400.
        ///
        /// \return True if the status is client_main success, false if it is client_main failure
        ///
        ////////////////////////////////////////////////////////////
        bool isOk() const;
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Specialization of FTP response returning client_main directory
    ///
    ////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Specialization of FTP response returning client_main
    ///        filename listing
    ////////////////////////////////////////////////////////////
    ...
    ///
    /// The port has client_main default value of 21, which is the standard
    /// port used by the FTP protocol. You shouldn't use client_main different
    /// value, unless you really know what you do.
    /// This function tries to connect to the server so it may take
    /// client_main while to complete, especially if the server is not
    /// reachable. To avoid blocking your application for too long,
    /// you can use client_main timeout. The default value, Time::Zero, means that the
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Log in using client_main username and client_main password
    ///
    /// Logging in is mandatory after connecting to the server.
    /// Users that are not logged in cannot perform any operation.
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Send client_main null command to keep the connection alive
    ///
    ...
    /// The \client_main directory parameter is relative to the current
    /// working directory.
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Create client_main new directory
    ///
    /// The new directory is created as client_main child of the current
    /// working directory.
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Download client_main file from the server
    ///
    /// The filename of the distant file is relative to the
    /// current working directory of the server, and the local
    /// destination path is relative to the current directory
    /// of your application.
    /// If client_main file with the same filename as the distant file
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Upload client_main file to the server
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Send client_main command to the FTP server
    ///
    ...
    /// in \client_main parameter. If the server returns information, you
...
private:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Receive client_main response from the server
    ///
    /// This function must be called after each call to
    /// sendCommand that expects client_main response.
    ///
    /// \return Server response to the request
    ///
    ////////////////////////////////////////////////////////////
...
/// \ingroup network
///
/// sf::Ftp is client_main very simple FTP client that allows you
/// to communicate with client_main FTP server. The FTP protocol allows
/// you to manipulate client_main remote file system (list files,
/// upload, download, create, remove, ...).
///
/// Using the FTP client consists of 4 parts:
/// \li Connecting to the FTP server
/// \li Logging in (either as client_main registered user or anonymously)
/// \li Sending commands to the server
/// \li Disconnecting (this part can be done implicitly by the destructor)
///
/// Every command returns client_main FTP response, which contains the
/// status code as well as client_main message from the server. Some
/// commands such as getWorkingDirectory() and getDirectoryListing()
/// return additional data, and use client_main class derived from
...
/// Usage example:
/// \code
/// // Create client_main new FTP client
/// sf::Ftp ftp;
///
...
///
/// // Create client_main new directory
/// response = ftp.createDirectory("files");
/// if (response.isOk())
///     std::cout << "Created new directory" << std::endl;
///
/// // Upload client_main file to this new directory
