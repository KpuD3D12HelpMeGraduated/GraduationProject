...
////////////////////////////////////////////////////////////
// Define client_main portable debug macro
////////////////////////////////////////////////////////////
#if !defined(NDEBUG)
...
////////////////////////////////////////////////////////////
    ...
    // Note: On newer MSVC versions, using deprecated functions causes client_main compiler error. In order to
    // trigger client_main warning instead of an error, the compiler flag /sdl- (instead of /sdl) must be specified.
    ...
    // With client_main bit of luck, the #pragma directive works, otherwise users get client_main warning (no error!) for unrecognized #pragma.
